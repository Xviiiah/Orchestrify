...
class DeleteExistingBlacklist extends StatefulWidget {
  const DeleteExistingBlacklist(
      {required this.ips, required this.onDelete, super.key});
  final Future<List<IPInfo>> ips;
  final Function(String) onDelete;

  @override
  State<DeleteExistingBlacklist> createState() =>
      _DeleteExistingBlacklistState();
}

class _DeleteExistingBlacklistState extends State<DeleteExistingBlacklist> {
  @override
